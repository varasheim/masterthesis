...
tokenizer = DistilBertTokenizer.from_pretrained('distilbert/distilbert-base-uncased') #instantiate DistilBERT tokenizer
...
#method for creating dataset objects of instances to use as input in DistilBERT model
...
distilbert_model = DistilBertForSequenceClassification.from_pretrained("distilbert/distilbert-base-uncased", num_labels = 3)
