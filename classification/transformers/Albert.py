...
tokenizer = AlbertTokenizer.from_pretrained("albert-base-v2") #instantiate Albert tokenizer
...
#method for creating dataset objects of instances to use as input in Albert model
...
#instantiate Albert model
albert_base = AlbertForSequenceClassification.from_pretrained("albert-base-v2", num_labels=3)
